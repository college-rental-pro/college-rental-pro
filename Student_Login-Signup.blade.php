...
<html>
    ...
    <body>
        ...
        <div class="container" id="student-cards">
            <div class="row">

                <div class="col-sm-6">
                    <div class="card" id="student-login-card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-outline-primary" id="student-login">Login</button>
                        </div>
                    </div>
                </div>

                <div class="col-sm-6">
                    <div class="card" id="student-signup-card">
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-outline-success" id="student-signup">Sign Up</button>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#student-login').click(studentLogin());
            $('#student-signup').click(studentSignup());
